...
import { AccountModel, Hasher, LoadAccountByEmailRepository } from './db-add-account.protocol'
...
function mockLoadAccountByEmailRepository (): LoadAccountByEmailRepository {
